					...
					<el-row v-for="(attachment, index) in info.attachments" :key="index" :gutter="10" class="attachment-row">
						<el-col :span="6">
							<el-form-item label="关联表">
								<el-tag v-if="attachment.tableName" type="success" @click="handleChangeConfig(index)" closable @close="handleRemoveRelation(index)">{{attachment.tableName}}</el-tag>
								<el-tag v-else class="sel-attachment" @click="handleChangeConfig(index)">点击选择</el-tag>
							</el-form-item>
						</el-col>
						<el-col :span="6" >
							<el-form-item label="外键">
								<el-tag v-if="attachment.foreignKey" type="success" @click="handleChangeConfig(index)" closable @close="handleRemoveRelation(index)">{{attachment.foreignKey}}</el-tag>
								<el-tag v-else class="sel-attachment" @click="handleChangeConfig(index)">点击选择</el-tag>
							</el-form-item>
						</el-col>
						<el-col :span="10" >
