  ...
  <div class="hx-hxzhdj-detail">
    <el-drawer v-model="isShowDialog" size="80%" direction="ltr">
      ...
      <el-descriptions class="margin-top" :column="3" border style="margin: 8px;">
        ...
        <el-descriptions-item :span="1">
          <template #label>
            <div class="cell-item">基础信息</div>
          </template>
          {{ formData.basicInfo }}
        </el-descriptions-item>
        <el-descriptions-item :span="1">
          <template #label>
            <div class="cell-item">健康信息</div>
          </template>
          {{ formData.healthInfo }}
        </el-descriptions-item>
        <el-descriptions-item :span="1">
          <template #label>
            <div class="cell-item">家庭信息</div>
          </template>
          {{ formData.familyInfo }}
        </el-descriptions-item>
        <el-descriptions-item :span="1">
          <template #label>
            <div class="cell-item">社保信息</div>
          </template>
          {{ formData.socialInfo }}
        </el-descriptions-item>
        <el-descriptions-item :span="1">
...
defineOptions({ name: "ApiV1HxHxzhdjDetail" })
...
const parsedTags = computed(() => {
  return parseSpecialTags(state.formData.specialTags as string | null | undefined)
})
...
<style scoped>
.hx-hxzhdj-detail :deep(.el-form-item--large .el-form-item__label) {
  font-weight: bolder;
}
.pic-block {
  margin-right: 8px;
